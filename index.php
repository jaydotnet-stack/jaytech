              ...
              <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12" id = "heading">
                        <div class="hero-caption">
                           ...
                           <p style = "font-style: italic">I focus on building custom websites tailored to meet each client’s specific requirements. My goal is to deliver high-quality, functional, and user-friendly websites that make your online presence impactful and distinctive.</p> 
                        ...
                        <div id="page-1" class="page one">
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    ...
                                    <h4>Fullstack Developer</h4>
                                     <span class="position">Federal University of Technology, Akure</span>
                                </div>
                            </div>
                            <div class="resume-wrap transition d-flex">
                                <div class="icon d-flex align-items-center justify-content-center"> 
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    ...
                                    <h4>Website Developer</h4>
                                    <span class="position">Junior Web developer — Agrohaven (Remote).</span>
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    ...
                                    <h4>Website Developer</h4>
                                    <span class="position">Research Assistant — General Studies Unit (GNS), Federal University of Technology, Akure (FUTA).</span>
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    <span class="date">2021-2023</span>
                                    <h4>Lecturer</h4>
                                    <span class="position">Lecturer — Computer Software Engineering Department, Ipetu Ijesa College of Technology 
                                    (ICOTECH) (Part time).</span>
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    ...
                                    <h4>Website Developer</h4>
                                    <span class="position">Software Engineer — Information Communication Technology (ICT) Center, University of Medical 
                                    Sciences (Full Time).</span>
                ...
                <div class="contact-left">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body">
                            <h4>Email</h4>
                            <span><a href="mailto:abimbolaoladunni8429@gmail.com">abimbolaoladunni8429@gmail.com</a></span>
